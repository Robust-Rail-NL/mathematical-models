...
algorithms = {
  # "ADMM Continuous": "../../data/data_types_7hours/sp_continuous_results.csv",
...
for t in all_types:
  ...
  plt.savefig(f"../plots/time_type_{filename_t}.png", dpi=300, bbox_inches="tight")
  plt.close()
...
for t in all_types:
  ...
  filename_t = t.replace("/", "_")
  plt.savefig(f"../plots/solved_type_{filename_t}.png", dpi=300, bbox_inches="tight")
  plt.close()
