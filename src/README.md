...
- A location in robust-rail-solver format such as of the Kleine Binckhorst shunting yard [location_solver.json](https://github.com/Robust-Rail-NL/robust-rail-general/blob/main/Location_KleineBinckhorst/location_solver.json).
