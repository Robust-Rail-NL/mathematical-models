...
# LOAD DATA
# =========================
df = pd.read_csv("results_milp/combined_results.csv")
...
plt.savefig("results/milp/time_milp.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig("results/milp/solved_milp.png", dpi=300, bbox_inches="tight")
plt.close()