                        ...
                        )
                        {
                            ...
                            if (move.Cost.Cost(fullcost) < bestcost.Cost(fullcost))
                            {
                                ...
                                if (debugLevel > 1)
                                {
                                    ...
                                    Console.WriteLine($"New best solution at iteration {iteration}");
                                    Console.WriteLine($"Cost: {move.Cost}");
                                    Console.WriteLine($"Time elapsed: {(sw.ElapsedMilliseconds / (double)1000).ToString("N2")} seconds");
                                }
