...
PLAN_DIR=~/Robust-Rail-NL/mathematical-models/data_types_360/local_plans_ls_discreet
mkdir -p $PLAN_DIR
...
RESULT_FILE=~/Robust-Rail-NL/mathematical-models/data_types_360/results_ls_discreet/results_10_${SLURM_ARRAY_TASK_ID}.csv
